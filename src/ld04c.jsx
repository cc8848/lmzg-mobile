...
import gifSrc2 from './public/images/land/career2.gif';
import codeSrc2 from './public/images/land/04c.png';
...
class App extends Component {
    ...
    render() {
        return (
            <div className="land-main career-three">
                <Header {...this.props}/>
                <Banner />
                <Download gifSrc={gifSrc2} {...this.props}/>
